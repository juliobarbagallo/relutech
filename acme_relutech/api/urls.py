...
from .views import UserLoginAPIView, AssetsAPIView, LicensesAPIView
from . import views
...
urlpatterns = [
    ...
    path('v1/licenses/<int:pk>/', LicensesAPIView.as_view(), name='license-assignments'),
    path('v1/licenses/<int:developer_id>/<int:license_id>/', LicensesAPIView.as_view(), name='license-delete'),
]
